...
// Query untuk mengambil data dari tabel sorogan dengan filter
$sql = "SELECT 
            sorogan.id, 
            sorogan.jam, 
            sorogan.tanggal, 
        ...
        FROM 
            sorogan
        JOIN 
            daftar_santri ON sorogan.id_santri = daftar_santri.id
        JOIN 
...
if ($filter_tanggal != '') {
    $sql .= " AND sorogan.tanggal = '$filter_tanggal'";
}
...
<body>
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col-md-4">
                <a href="export_csv.php?filter_guru=<?php echo $filter_guru; ?>&filter_kelas=<?php echo $filter_kelas; ?>&filter_tanggal=<?php echo $filter_tanggal; ?>&filter_nama=<?php echo $filter_nama; ?>&kegiatan=sorogan" class="btn btn-success mt-4">Export CSV</a>
            </div>
        </div>
