...
// Query untuk mengambil data dari tabel lalaran dengan filter
$sql = "SELECT 
            lalaran.id, 
            lalaran.jam, 
            lalaran.tanggal, 
        ...
        FROM 
            lalaran
        JOIN 
            daftar_santri ON lalaran.id_santri = daftar_santri.id
        JOIN 
...
if ($filter_tanggal != '') {
    $sql .= " AND lalaran.tanggal = '$filter_tanggal'";
}
...
<body>
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col-md-4">
                <a href="export_csv.php?filter_guru=<?php echo $filter_guru; ?>&filter_kelas=<?php echo $filter_kelas; ?>&filter_tanggal=<?php echo $filter_tanggal; ?>&filter_nama=<?php echo $filter_nama; ?>&kegiatan=lalaran" class="btn btn-success mt-4">Export CSV</a>
            </div>
        </div>
